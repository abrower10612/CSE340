...
// create/provide access to the session
session_start();

// bring in outside resources that this controller will need
...
// collect the "action" value from the "post" or "get" options
// of the "request" from the browser.
