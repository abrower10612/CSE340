...
// this function will check for an existing email address in the clients database table
...
// this function handles the updating of an account in the inventory 
...
function updatePassword($clientPassword, $clientId)
{
  ...
  // Replaces the placeholder in the SQL
